...
RUN cd /var/lib/jenkins/workspace/tom-cat-job/target/hello-world-war-1.0.0 && cp -r /var/lib/jenkins/workspace/tom-cat-job/target/hello-world-war-1.0.0 /home/hello-world-war-1.0.0
